declare namespace PDFPreview {
  ...
  export interface Assessment {
    ...
    topFourIssues: Auth.TopIssue[];
    externalRiskIndicators: ExternalRiskIndicatorGroup[];
  }
  ...
  export interface SupplierMapping {
    ...
    traceMappingSuppliers: BrandSupplier.TraceProductDataPDF;
  }
  ...
  export interface PDFData {
    ...
    tiers: SupplyChain.SupplyChainTier[];
    language: string;
  }
  ...
  export type ExternalRiskIndicatorGroup = {
    countryRisk: Auth.ExternalRiskIndicator;
    riskIndicatorGroup: RiskIndicatorGroup[];
  };

  export type RiskIndicatorGroup = {
    riskIndicators: Auth.ExternalRiskIndicator[];
    good: string;
  };
}
