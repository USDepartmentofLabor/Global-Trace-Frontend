...
export default class CAPManagementContainer extends Vue {
  ...
  renderEmptyData(): JSX.Element {
    ...
    return (
      <Styled.Empty>
        <Styled.EmptyImage />
        <Styled.EmptyText>{this.$t('empty_improvement_plan')}</Styled.EmptyText>
      </Styled.Empty>
    );
  }
  ...
  renderTable(): JSX.Element {
    return (
      <Styled.Table>
        <Styled.Title>{this.$t('improvement_plans')}</Styled.Title>
        <DataTable
          numberRowLoading={5}
          ...
          scopedSlots={{
            tableRow: ({ item }: { item: CAP.CAP }) => (
              <RowItem
                ...
                openViewExtensionRequestModal={
                  this.openViewExtensionRequestModal
                }
              />
            ),
          }}
