...
export default class OnboardContainer extends Vue {
  ...
  get isDoneSAQ(): boolean {
    return this.userInfo && !isNull(this.userInfo.answeredSaqAt);
  }
      ...
      auth.hasManagePartnerMenu
        ? {
            ...
            isDone: this.userInfo
              ? !isNull(this.userInfo.addedPartnerAt)
              : false,
            onClick: () => {
    ...
    return (
      <Styled.MenuContainer>
        {this.menus.map((menu, index) => {
          ...
          return (
            <Styled.MenuItem vOn:click={() => menu.onClick()}>
