...
export default class Information extends Vue {
  ...
  renderCAP(): JSX.Element {
    if (this.properties.hasCAP) {
      return (
        <Styled.Input>
          <Input
            type={InputType.NUMBER}
            label={this.$t('improvement_plan')}
            placeholder={this.$t('enter_a_weight')}
            name="capWeight"
            height="48px"
            validation="bail|required|min:1"
            ...
            validationMessages={{
              required: this.$t('validation.required_weight', {
                field: this.$t('improvement_plan').toLowerCase(),
                interpolation: { escapeValue: false },
              }),
              min: this.$t('validation.min_weight', {
                field: this.$t('improvement_plan'),
                compare_field: 1,
              }),
            }}
          />
