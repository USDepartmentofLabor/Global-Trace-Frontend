...
export default class AttributeType extends Vue {
  ...
  get showInputTag(): boolean {
    return (
      (this.type.id === ProductAttributeEnum.LIST ||
        this.type.id === ProductAttributeEnum.NUMBER_UNIT_PAIR) &&
  ...
  get isDisabled(): boolean {
    return (
      (this.isSelectedProductId &&
        this.type.id !== ProductAttributeEnum.TEXT) ||
