...
export default class ProductHistory extends Vue {
  ...
  get filteredRequestFacilityOptions(): App.DropdownOption[] {
    return this.requestFacilityOptions.filter(
      ({ id }) => id !== get(this.selectedProductSupplier, 'id'),
    );
  }

  get filteredProductSupplierOptions(): App.DropdownOption[] {
    return this.productSupplierOptions.filter(
      ({ id }) => id !== get(this.selectedRequestFacility, 'id'),
    );
  }
    ...
    if (this.type === AddDNAOptionEnum.SYNTHETIC) {
      return (
        <Dropdown
          ...
          height="48px"
          options={this.filteredRequestFacilityOptions}
          width="100%"
  ...
  renderProductSupplier(): JSX.Element {
    return (
      <Dropdown
        ...
        height="48px"
        options={this.filteredProductSupplierOptions}
        width="100%"
