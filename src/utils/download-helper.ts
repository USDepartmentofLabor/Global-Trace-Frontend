...
export const downloadTaxonomyExploitationFile = (
  id: string,
  shortToken: string,
): string => {
  return `${API_URL}taxonomy-exploitations/upload-templates/${id}?shortToken=${shortToken}`;
};
...
export const downloadLatestProductTranslationUrl = (
  fileId: string,
  shortToken: string,
): string => {
  return `${API_URL}product-translations/products/${fileId}?shortToken=${shortToken}`;
};

export const downloadLatestAttributeTranslationUrl = (
  fileId: string,
  shortToken: string,
): string => {
  return `${API_URL}product-translations/attributes/${fileId}?shortToken=${shortToken}`;
};
