...
export default class AttributeInput extends Vue {
  ...
  get isPercentage(): boolean {
    return (
      this.attributeProperties.category === ProductAttributeEnum.PERCENTAGE
    );
  }
  ...
  get inputType(): InputType {
    return this.attributeProperties.category === ProductAttributeEnum.TEXT
      ? InputType.TEXT
      : InputType.NUMBER;
  }
  ...
  onChange(value: string | number) {
    ...
    this.change({
      ...
      value:
        this.inputType === InputType.NUMBER ? Number(this.value) : this.value,
    });
  }
