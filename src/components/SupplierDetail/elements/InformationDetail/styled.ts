...
const riskStyles = {
  Extreme: css`
    border-left-color: ${({ theme }) => theme.colors.crail};
  `,
  High: css`
    border-left-color: ${({ theme }) => theme.colors.treePoppy};
  `,
  Medium: css`
    border-left-color: ${({ theme }) => theme.colors.brightSun};
  `,
  Low: css`
    border-left-color: ${({ theme }) => theme.colors.jellyBean};
  `,
  'No weight': css`
