...
import fontIconEOT from 'assets/fonts/icomoon.eot';
import fontIconTTF from 'assets/fonts/icomoon.ttf';
import fontIconWOFF from 'assets/fonts/icomoon.woff';
...
export const ProduceTitle = styled.span`
  font-size: 20px;
  font-weight: 800;
  line-height: 28px;
  color: ${({ theme }) => theme.colors.highland};
...
export const ProducerHeader = styled.div`
  display: flex;
  align-items: center;
  gap: 12px;
  padding-bottom: 24px;
