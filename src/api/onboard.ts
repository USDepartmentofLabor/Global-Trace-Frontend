...
export const requestFacilityOarId = (
  ...
  httpRequest.post('/facilities/register-oarIds', params);

export const searchFacilityOarIds = (
  params: Onboard.RegisterOarIdParams,
): Promise<Onboard.OarIdItem[]> =>
  httpRequest.post('/facilities/search-oarIds', params);

export const registerOarId = (
  params: Onboard.RegisterOarIdParams,
): Promise<void> => httpRequest.post(`/facilities/register-oarIds`, params);

export const confirmMatchOarId = (params: Onboard.OarIdParam): Promise<void> =>
  httpRequest.get('facilities/oar-ids/confirm-match', { params });

export const rejectMatchOarId = (ids: string): Promise<Onboard.OarIdDetail> =>
  httpRequest.get(`facilities/oar-ids/reject-match?ids=${ids}`, {});
...
export const checkOarId = (
  ...
  httpRequest.post('/facilities/check-oarId', params);

export const getInviteRoles = (
  params: Onboard.PartnerRolesParams,
): Promise<Auth.Facility[]> => httpRequest.get('/partners/roles', { params });
